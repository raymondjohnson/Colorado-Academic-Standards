...
1. Distinguish food on a continuum from most healthy to least healthy.
...
1. Complete personal care tasks such as using clean tissues, washing hands, handling food hygienically, brushing teeth, and choosing appropriate clothing for the weather.
...
1. Communicate with familiar adults and accept or request guidance.
2. Cooperate with others.
3. Develop friendships with peers.
4. Establish secure relationships with adults.
5. Use socially appropriate behavior with peers and adults, such as helping, sharing and taking turns.
6. Resolve conflict with peers alone and/or with adult intervention as appropriate.
7. Recognize and label others’ emotions.
...
2. Demonstrate age-appropriate independence in a range of activities, routines and tasks.
...
2. Handle impulses and behavior with minimal direction.
3. Follow simple rules, routines and directions.
...
1. Express a range of emotions appropriately, such as excitement, happiness, sadness, and fear.
...
1. State how to be a safe walking across the street.
2. Follow basic health and safety rules inside and outside the classroom.
...
1. Begin to understand the importance of personal space.
2. Explain the importance of personal space in the classroom and around others.
3. Explain that each person has the right to tell others not to touch his or her body.
4. Identify "appropriate" and "inappropriate" touches.
