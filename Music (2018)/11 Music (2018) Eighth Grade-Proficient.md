# Eighth Grade/Proficient | Music

## Standard 1. Expression of Music

### Grade Level Expectation MU.8P.1.1: Perform contrasting pieces of music, making interpretive and expressive choices.
...
### Grade Level Expectation MU.8P.1.2: Perform music in three or more parts accurately and with technique in order to convey intent.
...
### Grade Level Expectation MU.8P.1.3: Apply personal and prescribed criteria to develop a practice cycle.
...
### Grade Level Expectation MU.8P.2.1: Compose, improvise, and arrange increasingly complex melodic and rhythmic phrases with variations to convey intent.
...
### Grade Level Expectation MU.8P.3.1: Read, notate, and identify by name or function complex standard symbols for rhythm, pitch articulation, dynamics, tempo, and form.
...
### Grade Level Expectation MU.8P.3.2: Analyze structure, use of musical elements, and expressive choices within musical compositions.
...
### Grade Level Expectation MU.8P.3.3: Aurally identify and differentiate elements  of a piece  including chords  and harmonic progression.
...
### Grade Level Expectation MU.8P.3.4: Aurally identify and differentiate characteristics and expressive elements of different musical styles/genres.
...
### Grade Level Expectation MU.8P.4.1: Evaluate and assess the quality of musical performances or compositions using student-created criteria.
...
### Grade Level Expectation MU.8P.4.2: Identify and describe ways in which music is selected for use in society.
...
### Grade Level Expectation MU.8P.4.3: Identify and describe musical characteristics and performance styles of different world cultures.
...
### Grade Level Expectation MU.8P.4.4: Compare and contrast uses for music in historical events.
