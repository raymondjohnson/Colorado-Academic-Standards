...
### Grade Level Expectation DA.1.1.1: Accurately demonstrate simple movement sequences.
...
3. Demonstrate various qualities in movement.

#### Academic Contexts and Connections

##### Colorado Essential Skills:

1. Dance can communicate emotion and feelings. (Interpersonal Communication, Self-Awareness)
2. Students can use several pieces of information to inform a dance. (Critical Thinking and Analysis)

##### Inquiry Questions:

1. How does movement help you to process and/or change your feelings?
2. How can we affect the quality of movement?

### Grade Level Expectation DA.1.1.2: Develop safe movement practices.
...
1. Demonstrate focus and concentration while moving.
...
2. Movement practice supports an individual's social/emotional and physical wellbeing. (Self-Management)
3. Dancing can increase body awareness and promote risk-taking. (Perseverance and Resilience)

##### Inquiry Questions:

1. What is body awareness?
2. How does it feel when you are focusing and in control when you are dancing? How does it feel when movement is chaotic and wild?
3. How can you dance safely without hurting yourself?

## Standard 2. Create

### Grade Level Expectation DA.1.2.1: Explore movement based on a variety of inspirations.
...
4. Solve simple movement problems.
...
2. How did doing that dance make you feel?
3. Can you demonstrate how a rocket ship would move from low to high?

### Grade Level Expectation DA.1.2.2: Create and demonstrate simple movements based on play and improvisation.
...
1. Use play and improvisation to create movements.
2. Select movements they like and dislike and replicate them.
3. Change movements based on feedback and conversation.
...
3. What is a shape you can make with your body to show the feelings of the story?

## Standard 3. Historical and Cultural Context

### Grade Level Expectation DA.1.3.1: Perform movements that represent different eras and cultures.
...
### Grade Level Expectation DA.1.3.2: Recognize and describe ways in which dance represents different eras and cultures.
...
1. How is dance used to celebrate?
...
### Grade Level Expectation DA.1.4.1: Describe dance using basic movement vocabulary and make connections to other aspects of life.
...
### Grade Level Expectation DA.1.4.2: Connect dance to the world around the student.
